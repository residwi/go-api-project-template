...
// NewMockTokenCodec creates a new instance of MockTokenCodec. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockTokenCodec(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockTokenCodec {
	mock := &MockTokenCodec{}
...
// MockTokenCodec is an autogenerated mock type for the TokenCodec type
type MockTokenCodec struct {
	mock.Mock
}

type MockTokenCodec_Expecter struct {
	mock *mock.Mock
}

func (_m *MockTokenCodec) EXPECT() *MockTokenCodec_Expecter {
	return &MockTokenCodec_Expecter{mock: &_m.Mock}
}

// Parse provides a mock function for the type MockTokenCodec
func (_mock *MockTokenCodec) Parse(token string) (domain.Claims, error) {
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(string) (domain.Claims, error)); ok {
		return returnFunc(token)
	}
	if returnFunc, ok := ret.Get(0).(func(string) domain.Claims); ok {
		r0 = returnFunc(token)
	} else {
...
// MockTokenCodec_Parse_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Parse'
type MockTokenCodec_Parse_Call struct {
	*mock.Call
}

// Parse is a helper method to define mock.On call
//   - token string
func (_e *MockTokenCodec_Expecter) Parse(token any) *MockTokenCodec_Parse_Call {
	return &MockTokenCodec_Parse_Call{Call: _e.mock.On("Parse", token)}
}

func (_c *MockTokenCodec_Parse_Call) Run(run func(token string)) *MockTokenCodec_Parse_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 string
		if args[0] != nil {
			arg0 = args[0].(string)
...
func (_c *MockTokenCodec_Parse_Call) Return(claims domain.Claims, err error) *MockTokenCodec_Parse_Call {
	_c.Call.Return(claims, err)
	return _c
}

func (_c *MockTokenCodec_Parse_Call) RunAndReturn(run func(token string) (domain.Claims, error)) *MockTokenCodec_Parse_Call {
	_c.Call.Return(run)
	return _c
}

// Sign provides a mock function for the type MockTokenCodec
func (_mock *MockTokenCodec) Sign(claims domain.Claims, ttl time.Duration) (string, error) {
	ret := _mock.Called(claims, ttl)
	...
	var r0 string
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(domain.Claims, time.Duration) (string, error)); ok {
		return returnFunc(claims, ttl)
	}
	if returnFunc, ok := ret.Get(0).(func(domain.Claims, time.Duration) string); ok {
		r0 = returnFunc(claims, ttl)
	} else {
		r0 = ret.Get(0).(string)
	}
	if returnFunc, ok := ret.Get(1).(func(domain.Claims, time.Duration) error); ok {
		r1 = returnFunc(claims, ttl)
	} else {
		r1 = ret.Error(1)
	}
	return r0, r1
...
// MockTokenCodec_Sign_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Sign'
type MockTokenCodec_Sign_Call struct {
	*mock.Call
}
...
//   - ttl time.Duration
func (_e *MockTokenCodec_Expecter) Sign(claims any, ttl any) *MockTokenCodec_Sign_Call {
	return &MockTokenCodec_Sign_Call{Call: _e.mock.On("Sign", claims, ttl)}
}

func (_c *MockTokenCodec_Sign_Call) Run(run func(claims domain.Claims, ttl time.Duration)) *MockTokenCodec_Sign_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockTokenCodec_Sign_Call) Return(s string, err error) *MockTokenCodec_Sign_Call {
	_c.Call.Return(s, err)
	return _c
}

func (_c *MockTokenCodec_Sign_Call) RunAndReturn(run func(claims domain.Claims, ttl time.Duration) (string, error)) *MockTokenCodec_Sign_Call {
	_c.Call.Return(run)
	return _c
}
