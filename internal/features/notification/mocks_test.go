...
// EnqueueSend provides a mock function for the type MockJobQueue
func (_mock *MockJobQueue) EnqueueSend(ctx context.Context, notificationID uuid.UUID) error {
...
// MockJobQueue_EnqueueSend_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'EnqueueSend'
type MockJobQueue_EnqueueSend_Call struct {
	*mock.Call
}
...
func (_e *MockJobQueue_Expecter) EnqueueSend(ctx any, notificationID any) *MockJobQueue_EnqueueSend_Call {
	return &MockJobQueue_EnqueueSend_Call{Call: _e.mock.On("EnqueueSend", ctx, notificationID)}
}

func (_c *MockJobQueue_EnqueueSend_Call) Run(run func(ctx context.Context, notificationID uuid.UUID)) *MockJobQueue_EnqueueSend_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockJobQueue_EnqueueSend_Call) Return(err error) *MockJobQueue_EnqueueSend_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockJobQueue_EnqueueSend_Call) RunAndReturn(run func(ctx context.Context, notificationID uuid.UUID) error) *MockJobQueue_EnqueueSend_Call {
	_c.Call.Return(run)
	return _c
}
