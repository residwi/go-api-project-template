...
func (_mock *MockRepository) GetByID(ctx context.Context, id uuid.UUID) (*domain.Category, error) {
	ret := _mock.Called(ctx, id)
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID) (*domain.Category, error)); ok {
		return returnFunc(ctx, id)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID) *domain.Category); ok {
		r0 = returnFunc(ctx, id)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockRepository_GetByID_Call) Return(category *domain.Category, err error) *MockRepository_GetByID_Call {
	_c.Call.Return(category, err)
	return _c
}

func (_c *MockRepository_GetByID_Call) RunAndReturn(run func(ctx context.Context, id uuid.UUID) (*domain.Category, error)) *MockRepository_GetByID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockRepository) Update(ctx context.Context, cat *domain.Category) error {
	ret := _mock.Called(ctx, cat)
...
func (_c *MockRepository_Update_Call) Run(run func(ctx context.Context, cat *domain.Category)) *MockRepository_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockRepository_Update_Call) RunAndReturn(run func(ctx context.Context, cat *domain.Category) error) *MockRepository_Update_Call {
	_c.Call.Return(run)
	return _c
}
