...
func (_mock *MockRepository) GetOrderStatusBreakdown(ctx context.Context, from time.Time, to time.Time) ([]StatusBreakdown, error) {
	...
	var r0 []StatusBreakdown
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, time.Time, time.Time) ([]StatusBreakdown, error)); ok {
		return returnFunc(ctx, from, to)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, time.Time, time.Time) []StatusBreakdown); ok {
		r0 = returnFunc(ctx, from, to)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]StatusBreakdown)
		}
	}
...
func (_c *MockRepository_GetOrderStatusBreakdown_Call) Return(statusBreakdowns []StatusBreakdown, err error) *MockRepository_GetOrderStatusBreakdown_Call {
	_c.Call.Return(statusBreakdowns, err)
	return _c
}

func (_c *MockRepository_GetOrderStatusBreakdown_Call) RunAndReturn(run func(ctx context.Context, from time.Time, to time.Time) ([]StatusBreakdown, error)) *MockRepository_GetOrderStatusBreakdown_Call {
	_c.Call.Return(run)
	return _c
}

// GetRevenueByDay provides a mock function for the type MockRepository
func (_mock *MockRepository) GetRevenueByDay(ctx context.Context, from time.Time, to time.Time) ([]RevenueData, error) {
	ret := _mock.Called(ctx, from, to)
	...
	var r0 []RevenueData
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, time.Time, time.Time) ([]RevenueData, error)); ok {
		return returnFunc(ctx, from, to)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, time.Time, time.Time) []RevenueData); ok {
		r0 = returnFunc(ctx, from, to)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]RevenueData)
		}
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, time.Time, time.Time) error); ok {
		r1 = returnFunc(ctx, from, to)
...
func (_c *MockRepository_GetRevenueByDay_Call) Return(revenueDatas []RevenueData, err error) *MockRepository_GetRevenueByDay_Call {
	_c.Call.Return(revenueDatas, err)
	return _c
}

func (_c *MockRepository_GetRevenueByDay_Call) RunAndReturn(run func(ctx context.Context, from time.Time, to time.Time) ([]RevenueData, error)) *MockRepository_GetRevenueByDay_Call {
	_c.Call.Return(run)
	return _c
}

// GetSalesSummary provides a mock function for the type MockRepository
func (_mock *MockRepository) GetSalesSummary(ctx context.Context, from time.Time, to time.Time) (SalesSummary, error) {
	ret := _mock.Called(ctx, from, to)
	...
	var r0 SalesSummary
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, time.Time, time.Time) (SalesSummary, error)); ok {
		return returnFunc(ctx, from, to)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, time.Time, time.Time) SalesSummary); ok {
		r0 = returnFunc(ctx, from, to)
	} else {
		r0 = ret.Get(0).(SalesSummary)
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, time.Time, time.Time) error); ok {
		r1 = returnFunc(ctx, from, to)
	} else {
...
func (_c *MockRepository_GetSalesSummary_Call) Return(salesSummary SalesSummary, err error) *MockRepository_GetSalesSummary_Call {
	_c.Call.Return(salesSummary, err)
	return _c
}

func (_c *MockRepository_GetSalesSummary_Call) RunAndReturn(run func(ctx context.Context, from time.Time, to time.Time) (SalesSummary, error)) *MockRepository_GetSalesSummary_Call {
	_c.Call.Return(run)
	return _c
}

// GetTopProducts provides a mock function for the type MockRepository
func (_mock *MockRepository) GetTopProducts(ctx context.Context, limit int, from time.Time, to time.Time) ([]TopProduct, error) {
	...
	var r0 []TopProduct
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, int, time.Time, time.Time) ([]TopProduct, error)); ok {
		return returnFunc(ctx, limit, from, to)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, int, time.Time, time.Time) []TopProduct); ok {
		r0 = returnFunc(ctx, limit, from, to)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]TopProduct)
		}
	}
...
func (_c *MockRepository_GetTopProducts_Call) Return(topProducts []TopProduct, err error) *MockRepository_GetTopProducts_Call {
	_c.Call.Return(topProducts, err)
	return _c
}

func (_c *MockRepository_GetTopProducts_Call) RunAndReturn(run func(ctx context.Context, limit int, from time.Time, to time.Time) ([]TopProduct, error)) *MockRepository_GetTopProducts_Call {
	_c.Call.Return(run)
	return _c
}
