...
func (_mock *MockProductLookup) GetByID(ctx context.Context, id uuid.UUID) (*cart.ProductInfo, error) {
	...
	var r0 *cart.ProductInfo
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID) (*cart.ProductInfo, error)); ok {
		return returnFunc(ctx, id)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID) *cart.ProductInfo); ok {
		r0 = returnFunc(ctx, id)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*cart.ProductInfo)
		}
	}
...
func (_c *MockProductLookup_GetByID_Call) Return(productInfo *cart.ProductInfo, err error) *MockProductLookup_GetByID_Call {
	_c.Call.Return(productInfo, err)
	return _c
}

func (_c *MockProductLookup_GetByID_Call) RunAndReturn(run func(ctx context.Context, id uuid.UUID) (*cart.ProductInfo, error)) *MockProductLookup_GetByID_Call {
	_c.Call.Return(run)
	return _c
}

// GetByIDs provides a mock function for the type MockProductLookup
func (_mock *MockProductLookup) GetByIDs(ctx context.Context, ids []uuid.UUID) (map[uuid.UUID]cart.ProductInfo, error) {
	...
	var r0 map[uuid.UUID]cart.ProductInfo
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, []uuid.UUID) (map[uuid.UUID]cart.ProductInfo, error)); ok {
		return returnFunc(ctx, ids)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, []uuid.UUID) map[uuid.UUID]cart.ProductInfo); ok {
		r0 = returnFunc(ctx, ids)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[uuid.UUID]cart.ProductInfo)
		}
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, []uuid.UUID) error); ok {
...
func (_c *MockProductLookup_GetByIDs_Call) Return(uUIDToProductInfo map[uuid.UUID]cart.ProductInfo, err error) *MockProductLookup_GetByIDs_Call {
	_c.Call.Return(uUIDToProductInfo, err)
	return _c
}

func (_c *MockProductLookup_GetByIDs_Call) RunAndReturn(run func(ctx context.Context, ids []uuid.UUID) (map[uuid.UUID]cart.ProductInfo, error)) *MockProductLookup_GetByIDs_Call {
	_c.Call.Return(run)
	return _c
}
