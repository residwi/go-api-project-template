...
var _ deduct.Repository = (*Repository)(nil)
...
// DeductBatch moves only reserved_stock: available_stock was already reduced
...
func (r *Repository) Deduct(ctx context.Context, productID uuid.UUID, qty int) (*domain.Stock, error) {
	db := database.DB(ctx, r.pool)
