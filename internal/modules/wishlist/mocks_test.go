...
// ListItemsForUser provides a mock function for the type MockRepository
func (_mock *MockRepository) ListItemsForUser(ctx context.Context, userID uuid.UUID, cursor paging.CursorPage) ([]domain.Item, error) {
...
// MockRepository_ListItemsForUser_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ListItemsForUser'
type MockRepository_ListItemsForUser_Call struct {
	*mock.Call
}
...
func (_e *MockRepository_Expecter) ListItemsForUser(ctx any, userID any, cursor any) *MockRepository_ListItemsForUser_Call {
	return &MockRepository_ListItemsForUser_Call{Call: _e.mock.On("ListItemsForUser", ctx, userID, cursor)}
}

func (_c *MockRepository_ListItemsForUser_Call) Run(run func(ctx context.Context, userID uuid.UUID, cursor paging.CursorPage)) *MockRepository_ListItemsForUser_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockRepository_ListItemsForUser_Call) Return(items []domain.Item, err error) *MockRepository_ListItemsForUser_Call {
	_c.Call.Return(items, err)
	return _c
}

func (_c *MockRepository_ListItemsForUser_Call) RunAndReturn(run func(ctx context.Context, userID uuid.UUID, cursor paging.CursorPage) ([]domain.Item, error)) *MockRepository_ListItemsForUser_Call {
	_c.Call.Return(run)
	return _c
}
