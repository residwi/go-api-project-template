...
func (_mock *MockRepository) GetItems(ctx context.Context, userID uuid.UUID, cursor paging.CursorPage) ([]Item, error) {
	...
	var r0 []Item
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID, paging.CursorPage) ([]Item, error)); ok {
		return returnFunc(ctx, userID, cursor)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID, paging.CursorPage) []Item); ok {
...
func (_c *MockRepository_GetItems_Call) Return(items []Item, err error) *MockRepository_GetItems_Call {
	_c.Call.Return(items, err)
	return _c
}

func (_c *MockRepository_GetItems_Call) RunAndReturn(run func(ctx context.Context, userID uuid.UUID, cursor paging.CursorPage) ([]Item, error)) *MockRepository_GetItems_Call {
	_c.Call.Return(run)
	return _c
}
