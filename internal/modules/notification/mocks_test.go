...
// NewMockSendQueue creates a new instance of MockSendQueue. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockSendQueue(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockSendQueue {
	mock := &MockSendQueue{}
...
// MockSendQueue is an autogenerated mock type for the SendQueue type
type MockSendQueue struct {
	mock.Mock
}

type MockSendQueue_Expecter struct {
	mock *mock.Mock
}

func (_m *MockSendQueue) EXPECT() *MockSendQueue_Expecter {
	return &MockSendQueue_Expecter{mock: &_m.Mock}
}

// EnqueueSend provides a mock function for the type MockSendQueue
func (_mock *MockSendQueue) EnqueueSend(ctx context.Context, notificationID uuid.UUID) error {
...
// MockSendQueue_EnqueueSend_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'EnqueueSend'
type MockSendQueue_EnqueueSend_Call struct {
	*mock.Call
}
...
func (_e *MockSendQueue_Expecter) EnqueueSend(ctx any, notificationID any) *MockSendQueue_EnqueueSend_Call {
	return &MockSendQueue_EnqueueSend_Call{Call: _e.mock.On("EnqueueSend", ctx, notificationID)}
}

func (_c *MockSendQueue_EnqueueSend_Call) Run(run func(ctx context.Context, notificationID uuid.UUID)) *MockSendQueue_EnqueueSend_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockSendQueue_EnqueueSend_Call) Return(err error) *MockSendQueue_EnqueueSend_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockSendQueue_EnqueueSend_Call) RunAndReturn(run func(ctx context.Context, notificationID uuid.UUID) error) *MockSendQueue_EnqueueSend_Call {
	_c.Call.Return(run)
	return _c
}
