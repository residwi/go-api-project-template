...
func (_mock *MockRepository) Claim(ctx context.Context, batchSize int, lease time.Duration) ([]Job, error) {
...
func (_c *MockRepository_Claim_Call) RunAndReturn(run func(ctx context.Context, batchSize int, lease time.Duration) ([]Job, error)) *MockRepository_Claim_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockRepository) Create(ctx context.Context, n *Notification) error {
...
func (_c *MockRepository_Create_Call) Run(run func(ctx context.Context, n *Notification)) *MockRepository_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockRepository_Create_Call) RunAndReturn(run func(ctx context.Context, n *Notification) error) *MockRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}

// CreateAndComplete provides a mock function for the type MockRepository
func (_mock *MockRepository) CreateAndComplete(ctx context.Context, n *Notification, job *Job) error {
...
func (_c *MockRepository_CreateAndComplete_Call) Run(run func(ctx context.Context, n *Notification, job *Job)) *MockRepository_CreateAndComplete_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockRepository_CreateAndComplete_Call) RunAndReturn(run func(ctx context.Context, n *Notification, job *Job) error) *MockRepository_CreateAndComplete_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockRepository) ListByUser(ctx context.Context, userID uuid.UUID, cursor paging.CursorPage) ([]Notification, error) {
	...
	var r0 []Notification
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID, paging.CursorPage) ([]Notification, error)); ok {
		return returnFunc(ctx, userID, cursor)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID, paging.CursorPage) []Notification); ok {
...
func (_c *MockRepository_ListByUser_Call) Return(notifications []Notification, err error) *MockRepository_ListByUser_Call {
	_c.Call.Return(notifications, err)
	return _c
}

func (_c *MockRepository_ListByUser_Call) RunAndReturn(run func(ctx context.Context, userID uuid.UUID, cursor paging.CursorPage) ([]Notification, error)) *MockRepository_ListByUser_Call {
	_c.Call.Return(run)
	return _c
}
