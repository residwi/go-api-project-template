...
func New(
	...
	return &UseCase{repo: repo, orders: orders, finalizer: finalizer, jobs: jobs, secret: secret, logger: log}
}
...
func (c *UseCase) Execute(ctx context.Context, payload []byte, signature string) error {
