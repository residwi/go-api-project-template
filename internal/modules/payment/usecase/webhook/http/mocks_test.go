...
func (_mock *MockCommand) Execute(ctx context.Context, payload []byte, signature string) error {
...
//   - payload []byte
//   - signature string
func (_e *MockCommand_Expecter) Execute(ctx any, payload any, signature any) *MockCommand_Execute_Call {
	return &MockCommand_Execute_Call{Call: _e.mock.On("Execute", ctx, payload, signature)}
}

func (_c *MockCommand_Execute_Call) Run(run func(ctx context.Context, payload []byte, signature string)) *MockCommand_Execute_Call {
...
func (_c *MockCommand_Execute_Call) RunAndReturn(run func(ctx context.Context, payload []byte, signature string) error) *MockCommand_Execute_Call {
	_c.Call.Return(run)
	return _c
}
