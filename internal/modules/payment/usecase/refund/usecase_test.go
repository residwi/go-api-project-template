...
func TestCommand_ProcessRefund(t *testing.T) {
	...
	t.Run("success with release inventory", func(t *testing.T) {
		...
		inventoryRestore.EXPECT().Restore(mock.Anything, mock.Anything, inventory.Reserved).
			Return(nil)
	...
	t.Run("success with restock inventory", func(t *testing.T) {
		...
		inventoryRestore.EXPECT().Restore(mock.Anything, mock.Anything, inventory.Deducted).
			Return(nil)
