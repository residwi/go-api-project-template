...
func (_mock *MockUseCase) Execute(ctx context.Context, paymentID uuid.UUID) error {
...
//   - ctx context.Context
//   - paymentID uuid.UUID
func (_e *MockUseCase_Expecter) Execute(ctx any, paymentID any) *MockUseCase_Execute_Call {
	return &MockUseCase_Execute_Call{Call: _e.mock.On("Execute", ctx, paymentID)}
}

func (_c *MockUseCase_Execute_Call) Run(run func(ctx context.Context, paymentID uuid.UUID)) *MockUseCase_Execute_Call {
...
func (_c *MockUseCase_Execute_Call) RunAndReturn(run func(ctx context.Context, paymentID uuid.UUID) error) *MockUseCase_Execute_Call {
	_c.Call.Return(run)
	return _c
}
