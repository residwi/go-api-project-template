...
func (_mock *MockRepository) Create(ctx context.Context, cat *Category) error {
...
func (_c *MockRepository_Create_Call) Run(run func(ctx context.Context, cat *Category)) *MockRepository_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockRepository_Create_Call) RunAndReturn(run func(ctx context.Context, cat *Category) error) *MockRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockRepository) GetByID(ctx context.Context, id uuid.UUID) (*Category, error) {
	ret := _mock.Called(ctx, id)
...
func (_c *MockRepository_GetByID_Call) Return(category *Category, err error) *MockRepository_GetByID_Call {
	_c.Call.Return(category, err)
	return _c
}

func (_c *MockRepository_GetByID_Call) RunAndReturn(run func(ctx context.Context, id uuid.UUID) (*Category, error)) *MockRepository_GetByID_Call {
	_c.Call.Return(run)
	return _c
}

// GetBySlug provides a mock function for the type MockRepository
func (_mock *MockRepository) GetBySlug(ctx context.Context, slug string) (*Category, error) {
...
func (_c *MockRepository_GetBySlug_Call) Return(category *Category, err error) *MockRepository_GetBySlug_Call {
	_c.Call.Return(category, err)
	return _c
}

func (_c *MockRepository_GetBySlug_Call) RunAndReturn(run func(ctx context.Context, slug string) (*Category, error)) *MockRepository_GetBySlug_Call {
	_c.Call.Return(run)
	return _c
}

// List provides a mock function for the type MockRepository
func (_mock *MockRepository) List(ctx context.Context) ([]Category, error) {
...
func (_c *MockRepository_List_Call) Return(categorys []Category, err error) *MockRepository_List_Call {
	_c.Call.Return(categorys, err)
	return _c
}

func (_c *MockRepository_List_Call) RunAndReturn(run func(ctx context.Context) ([]Category, error)) *MockRepository_List_Call {
	_c.Call.Return(run)
	return _c
}

// Update provides a mock function for the type MockRepository
func (_mock *MockRepository) Update(ctx context.Context, cat *Category) error {
	ret := _mock.Called(ctx, cat)
...
func (_c *MockRepository_Update_Call) Run(run func(ctx context.Context, cat *Category)) *MockRepository_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockRepository_Update_Call) RunAndReturn(run func(ctx context.Context, cat *Category) error) *MockRepository_Update_Call {
	_c.Call.Return(run)
	return _c
}
