...
func (_mock *MockRepository) Create(ctx context.Context, review *Review) error {
...
func (_c *MockRepository_Create_Call) Run(run func(ctx context.Context, review *Review)) *MockRepository_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockRepository_Create_Call) RunAndReturn(run func(ctx context.Context, review *Review) error) *MockRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockRepository) GetByID(ctx context.Context, id uuid.UUID) (*Review, error) {
	ret := _mock.Called(ctx, id)
...
func (_c *MockRepository_GetByID_Call) Return(review *Review, err error) *MockRepository_GetByID_Call {
	_c.Call.Return(review, err)
	return _c
}

func (_c *MockRepository_GetByID_Call) RunAndReturn(run func(ctx context.Context, id uuid.UUID) (*Review, error)) *MockRepository_GetByID_Call {
	_c.Call.Return(run)
	return _c
}

// GetStats provides a mock function for the type MockRepository
func (_mock *MockRepository) GetStats(ctx context.Context, productID uuid.UUID) (Stats, error) {
	...
	var r0 Stats
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID) (Stats, error)); ok {
		return returnFunc(ctx, productID)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID) Stats); ok {
...
func (_c *MockRepository_GetStats_Call) Return(stats Stats, err error) *MockRepository_GetStats_Call {
	_c.Call.Return(stats, err)
	return _c
}

func (_c *MockRepository_GetStats_Call) RunAndReturn(run func(ctx context.Context, productID uuid.UUID) (Stats, error)) *MockRepository_GetStats_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockRepository) ListByProduct(ctx context.Context, productID uuid.UUID, cursor paging.CursorPage) ([]Review, error) {
	...
	var r0 []Review
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID, paging.CursorPage) ([]Review, error)); ok {
		return returnFunc(ctx, productID, cursor)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID, paging.CursorPage) []Review); ok {
...
func (_c *MockRepository_ListByProduct_Call) Return(reviews []Review, err error) *MockRepository_ListByProduct_Call {
	_c.Call.Return(reviews, err)
	return _c
}

func (_c *MockRepository_ListByProduct_Call) RunAndReturn(run func(ctx context.Context, productID uuid.UUID, cursor paging.CursorPage) ([]Review, error)) *MockRepository_ListByProduct_Call {
	_c.Call.Return(run)
	return _c
}
