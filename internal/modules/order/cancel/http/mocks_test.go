...
func (_mock *MockCommand) Execute(ctx context.Context, userID uuid.UUID, orderID uuid.UUID) error {
...
//   - userID uuid.UUID
//   - orderID uuid.UUID
func (_e *MockCommand_Expecter) Execute(ctx any, userID any, orderID any) *MockCommand_Execute_Call {
	return &MockCommand_Execute_Call{Call: _e.mock.On("Execute", ctx, userID, orderID)}
}

func (_c *MockCommand_Execute_Call) Run(run func(ctx context.Context, userID uuid.UUID, orderID uuid.UUID)) *MockCommand_Execute_Call {
...
func (_c *MockCommand_Execute_Call) RunAndReturn(run func(ctx context.Context, userID uuid.UUID, orderID uuid.UUID) error) *MockCommand_Execute_Call {
	_c.Call.Return(run)
	return _c
}
