...
func TestUseCase_CancelByUser(t *testing.T) {
	t.Parallel()
	...
	t.Run("invalid transition from delivered", func(t *testing.T) {
		...
		cmd, repo, transition, _ := newTestCommand(t)
	...
	t.Run("success cancels awaiting_payment order", func(t *testing.T) {
		...
		cmd, repo, transition, inventory := newTestCommand(t)
	...
	t.Run("success releases coupon on cancel", func(t *testing.T) {
		...
		cmd, repo, transition, inventory, coupons := newTestCommandWithCoupons(t)
...
// TestUseCase_CancelUnpaid runs the same cancelWithReversal path as
// CancelByUser, minus the ownership check: the payment webhook has no caller
// to own the order against.
func TestUseCase_CancelUnpaid(t *testing.T) {
	t.Parallel()
...
func newTestCommand(t *testing.T) (
	...
	*MockInventoryRestorer,
	...
	return cmd, repo, transition, inventory
}
...
func newTestCommandWithCoupons(t *testing.T) (
	...
	*MockCouponReleaser,
	...
	return cmd, repo, transition, inventory, coupons
}
