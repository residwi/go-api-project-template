...
func (_mock *MockAuthenticator) Authenticate(ctx context.Context, token string) (auth.ClaimsView, error) {
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) (auth.ClaimsView, error)); ok {
		return returnFunc(ctx, token)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) auth.ClaimsView); ok {
...
func (_c *MockAuthenticator_Authenticate_Call) Return(claimsView auth.ClaimsView, err error) *MockAuthenticator_Authenticate_Call {
	_c.Call.Return(claimsView, err)
	return _c
}

func (_c *MockAuthenticator_Authenticate_Call) RunAndReturn(run func(ctx context.Context, token string) (auth.ClaimsView, error)) *MockAuthenticator_Authenticate_Call {
	_c.Call.Return(run)
	return _c
}
