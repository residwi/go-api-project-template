...
internal/modules/payment/
  ...
  gateway/                the outbound Gateway port and its three real
                          ...
                          exemption names gateway.go alone, not the directory:
                          none of the three implementations declare a
                          json-tagged type of their own
