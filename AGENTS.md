...
internal/modules/<feature>/
  ...
  queue.go           the outbound job-enqueue port -- payment and
                     notification only (2), paired with adapter/jobs
